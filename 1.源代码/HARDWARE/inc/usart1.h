...
#define USART1_TXBUFF_SIZE   100    //定义串口1 发送缓冲区大小 256字节
#define USART2_TXBUFF_SIZE   100   //定义串口1 发送缓冲区大小 256字节

#if  USART1_RX_ENABLE                          //如果使能接收功能
#define USART1_RXBUFF_SIZE   100               //定义串口1 接收缓冲区大小 256字节
...
void Usart2_Init(unsigned int MyBaudRate);
